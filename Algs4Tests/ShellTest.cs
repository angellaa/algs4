...
namespace Algs4Tests
{
    ...
    public class ShellTest
    {
        ...
        public void Sort_TimeTable_IsNotStable()
        {
            ...
            TimeTable[] stableByShellSortSample = TimeTable.GetTestSample().ToArray();

            //rearrange an array of objects in uniformly random order
            Knuth.Shuffle<TimeTable>(stableByShellSortSample);

            //sort by TIME
            Shell.Sort(stableByShellSortSample, new TimeTableComparerByTime());
            ...
            //sort by CITY
            Shell.Sort(stableByShellSortSample, new TimeTableComparerByCity());
            ...
            CollectionAssert.AreNotEqual(sortedSample, stableByShellSortSample);
            CollectionAssert.AreEquivalent(sortedSample, stableByShellSortSample);
        }
